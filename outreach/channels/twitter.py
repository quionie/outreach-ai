"""Twitter/X DM sequence generator."""
...
PROMPT_FILE = Path(__file__).parent.parent / "prompts" / "twitter_dm.yml"
...
def generate_twitter_sequence(
    ...
    """Generate a 2-message Twitter/X DM sequence.
    ...
    Returns:
        LLMResponse with the generated Twitter DM sequence.
    """
    ...
    if variants > 1:
        variant_instruction = (
            f"Generate {variants} A/B variants for EACH DM. "
            "Each variant should have a different hook or angle."
        )
...
def _load_prompts() -> dict[str, str]:
    """Load the Twitter DM prompt template."""
