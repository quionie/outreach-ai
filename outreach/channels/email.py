"""Email sequence generator — multi-step cold email campaigns."""
...
PROMPT_FILE = Path(__file__).parent.parent / "prompts" / "email_sequence.yml"
...
def generate_email_sequence(
    ...
    """Generate a multi-step cold email sequence.
    ...
    Args:
        ...
        variants: Number of A/B variants per step (1-3).

    Returns:
        LLMResponse with the generated email sequence.
    """
    ...
    if variants > 1:
        variant_instruction = (
            f"Generate {variants} A/B variants for EACH step. "
            "Each variant should take a meaningfully different approach — "
            "different angles, hooks, or CTAs. Not just word swaps."
        )
...
def _load_prompts() -> dict[str, str]:
    """Load the email sequence prompt template."""
